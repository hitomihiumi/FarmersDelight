...
public class ModEntityTypes
{
	...
	private static final ResourceKey<EntityType<?>> ROTTEN_TOMATO_KEY = ResourceKey.create(
			Registries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(FarmersDelight.MODID, "rotten_tomato"));
